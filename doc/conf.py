...
sys.path.insert(0, os.path.join(src_path))
...
latex_documents = [
    (master_doc, 'py_cpp.tex', 'py\\_cpp Documentation',
     'Thomas Khyn', 'manual'),
]
...
man_pages = [
    (master_doc, 'py_cpp', 'py_cpp Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'py_cpp', 'py_cpp Documentation',
     author, 'py_cpp', 'One line description of project.',
     'Miscellaneous'),
]
